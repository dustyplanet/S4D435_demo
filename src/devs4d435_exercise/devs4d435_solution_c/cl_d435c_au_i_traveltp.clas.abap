CLASS cl_d435c_au_i_traveltp DEFINITION
  PUBLIC
...
CLASS CL_D435C_AU_I_TRAVELTP IMPLEMENTATION.


  METHOD /bobf/if_lib_auth_draft_active~check_instance_authority.

    DATA:
    lt_travels        TYPE d435c_t_itraveltp.    " Instance data typed with node's combined table type
