CLASS cl_d435e_d_travelnumber DEFINITION
  PUBLIC
...
CLASS CL_D435E_D_TRAVELNUMBER IMPLEMENTATION.


  METHOD /bobf/if_frw_determination~execute.

    DATA lt_travel TYPE d435e_t_itraveltp.
    DATA lr_travel TYPE REF TO d435e_s_itraveltp.
    DATA lt_changed_fields TYPE /bobf/t_frw_name.


    APPEND if_d435e_i_traveltp_c=>sc_node_attribute-d435e_i_traveltp-travelnumber
...
**********************************************************************
*    DATA lt_data TYPE d435e_t_itraveltp.
*
*    io_read->retrieve(
*      EXPORTING
*        iv_node                 = is_ctx-node_key
...
**            iv_root_key       =
*            is_data           = lr_data
*            it_changed_fields = VALUE #( ( if_d435e_i_traveltp_c=>sc_node_attribute-d435e_i_traveltp-travelnumber ) )
*
*         ).
*
*      ENDIF.
