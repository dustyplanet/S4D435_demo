CLASS cl_d435b_au_i_traveltp DEFINITION
  PUBLIC
...
CLASS CL_D435B_AU_I_TRAVELTP IMPLEMENTATION.


  METHOD /bobf/if_lib_auth_draft_active~check_instance_authority.

    DATA:
     lt_travels        TYPE d435b_t_itraveltp.    " Instance data typed with node's combined table type
...
*                ls_failed_key-key = <ls_travel>-key.
*                INSERT ls_failed_key INTO TABLE et_failed_key.
