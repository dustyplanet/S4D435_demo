CLASS cl_d435d_d_i_traveltp_action_a DEFINITION
  PUBLIC
...
CLASS CL_D435D_D_I_TRAVELTP_ACTION_A IMPLEMENTATION.


  METHOD /bobf/if_frw_determination~execute.

    DATA lt_travels        TYPE d435d_t_itraveltp.

    DATA lt_travels_active TYPE d435d_t_itraveltp.

    FIELD-SYMBOLS <ls_for_check> TYPE d435d_s_itraveltp.
...
*        READ TABLE lt_travels_active ASSIGNING <ls_for_check> INDEX 1.
      ...
      OR <ls_for_check>-enddate < sy-datum .
        ...
        lo_property_helper->set_action_enabled(
             iv_action_key = if_d435d_i_traveltp_c=>sc_action-d435d_i_traveltp-set_to_cancelled
...
**********************************************************************
      IF <ls_for_check>-startdate < sy-datum.  "travel already started - no editing of customer
        ...
        lo_property_helper->set_attribute_read_only(
              iv_attribute_name = if_d435d_i_traveltp_c=>sc_node_attribute-d435d_i_traveltp-customer
              iv_key            = <ls_travel>-key
              iv_value          = abap_true
             ).
        ...
        " Field StartDate
        lo_property_helper->set_attribute_read_only(
            iv_attribute_name = if_d435d_i_traveltp_c=>sc_node_attribute-d435d_i_traveltp-startdate
            iv_key            = <ls_travel>-key
            iv_value          = abap_true
             ).
