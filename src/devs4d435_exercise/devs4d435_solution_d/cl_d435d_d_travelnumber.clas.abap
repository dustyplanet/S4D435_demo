CLASS cl_d435d_d_travelnumber DEFINITION
  PUBLIC
...
CLASS CL_D435D_D_TRAVELNUMBER IMPLEMENTATION.
  ...
  METHOD /bobf/if_frw_determination~execute.
    ...
    APPEND if_d435d_i_traveltp_c=>sc_node_attribute-d435d_i_traveltp-travelnumber
...
**            iv_root_key       =
*            is_data           = lr_data
*            it_changed_fields = VALUE #( ( if_d435d_i_traveltp_c=>sc_node_attribute-d435d_i_traveltp-travelnumber ) )
*
*         ).
*
*      ENDIF.
