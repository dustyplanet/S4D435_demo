CLASS cl_d435e_v_sequence_of_dates DEFINITION
  PUBLIC
...
CLASS CL_D435E_V_SEQUENCE_OF_DATES IMPLEMENTATION.


METHOD /bobf/if_frw_validation~execute.

  DATA lt_travel TYPE d435e_t_itraveltp.
  DATA lt_travel_before TYPE d435e_t_itraveltp.
  ...
  CONSTANTS c_s_initial_travel TYPE d435e_s_itraveltp VALUE IS INITIAL.
...
**********************************************************************
    ...
    IF <ls_travel>-enddate < <ls_travel>-startdate.
      ...
      APPEND if_d435e_i_traveltp_c=>sc_node_attribute-d435e_i_traveltp-startdate
      TO ls_location-attributes.
      APPEND if_d435e_i_traveltp_c=>sc_node_attribute-d435e_i_traveltp-enddate
      TO ls_location-attributes.
...
*                         Key        = <ls_travel>-key
*                         attributes = value #(
*                              ( if_d435e_i_traveltp_c=>sc_node_attribute-d435e_i_traveltp-startdate    )
*                              ( if_d435e_i_traveltp_c=>sc_node_attribute-d435e_i_traveltp-enddate ) )
*                        )
*               ) TO lt_msg.
